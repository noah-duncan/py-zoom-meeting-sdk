...
void init_meeting_service_interface_binding(nb::module_ &m) {
    ...
    nb::enum_<ZOOM_SDK_NAMESPACE::MeetingFailCode>(m, "MeetingFailCode", nb::is_arithmetic())
        ...
        .value("MEETING_FAIL_AUTHORIZED_USER_NOT_INMEETING", ZOOM_SDK_NAMESPACE::MEETING_FAIL_AUTHORIZED_USER_NOT_INMEETING)
        .value("MEETING_FAIL_ON_BEHALF_TOKEN_CONFLICT_LOGIN_ERROR", ZOOM_SDK_NAMESPACE::MEETING_FAIL_ON_BEHALF_TOKEN_CONFLICT_LOGIN_ERROR)
        .value("MEETING_FAIL_USER_LEVEL_TOKEN_NOT_HAVE_HOST_ZAK_OBF", ZOOM_SDK_NAMESPACE::MEETING_FAIL_USER_LEVEL_TOKEN_NOT_HAVE_HOST_ZAK_OBF)
        .value("MEETING_FAIL_APP_CAN_NOT_ANONYMOUS_JOIN_MEETING", ZOOM_SDK_NAMESPACE::MEETING_FAIL_APP_CAN_NOT_ANONYMOUS_JOIN_MEETING)
        .value("MEETING_FAIL_ON_BEHALF_TOKEN_INVALID", ZOOM_SDK_NAMESPACE::MEETING_FAIL_ON_BEHALF_TOKEN_INVALID)
        .value("MEETING_FAIL_ON_BEHALF_TOKEN_NOT_MATCH_MEETING", ZOOM_SDK_NAMESPACE::MEETING_FAIL_ON_BEHALF_TOKEN_NOT_MATCH_MEETING)
